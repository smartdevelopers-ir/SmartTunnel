...
/////////////////
    ...
    */
    public void start() throws IOException{
       ...
       Log.i("TTT",String.format("Starting UDP relay server on %s:%d, Remote socket %s:%d",
               relayIP, relayPort,
...
////////////////////
    public void run(){
       try{
          ...
          abort();
          Log.i("TTT",String.format("UDP Pipe thread %s stopped.", Thread.currentThread().getName()));
       }
...
/////////////////
    private synchronized void abort(){
       ...
       Log.i("TTT","Aborting UDP Relay Server");
    ...
    private void pipe(DatagramSocket from,DatagramSocket to,boolean out)
       ...
       while(true){
          try{
            ...
            Log.e("TTT","Dropping datagram for unknown host");
